...
class MenuUtility
{
    ...
    {
        array_walk($menuArray, [$this, 'removeNavTitleFromMenuItem']);
        return $menuArray;
    }
    ...
    public function replaceATagMarkersInMenuPartsIProcFunc(
        ...
        foreach (['before', 'after'] as $markerReplacePart) {
            ...
            $itemConfig['parts'][$markerReplacePart] = $templateService->substituteMarkerArray(
                $itemConfig['parts'][$markerReplacePart],
                $markerArray,
                '###|###'
            );
        }
